<template>
	<div class="container">
		...
		<!-- 学生基本信息 -->
		<v-studentbaseinfo></v-studentbaseinfo>
		<div class="nav">
			<img src="../assets/images/logo.png" height="70" width="70" class="logo">
			<ul>
				<li>
					<router-link to="/teacher/tea1">
						<i class="fa fa-home fa-lg" aria-hidden="true"></i>
		                <span>学生信息</span>
	            	</router-link>
	            </li>
				<li>
					<router-link to="/teacher/tea2">
		...
		<div class="content">
			<div class="webNav">
				<a href="/#/teacher">网站首页</a> / {{pageTitle}}
			</div>
...
<script>
    import StudentBaseInfo from './studentBaseInfo.vue'
	...
	export default {
		...
		components:{
			...
			'v-studentbaseinfo':StudentBaseInfo
		},
		methods:{
			logOutToggle(){
